...
Namespace SPF.Server.Schema.Interface.Generated
    Public Interface IHTCTerminateDocumentUserAccessTask
        Inherits IObject, ISPFSchedulerTask
...
#End Region
    ...
    Public MustInherit Class IHTCTerminateDocumentUserAccessTaskBase
        Inherits InterfaceBase
        Implements IHTCTerminateDocumentUserAccessTask

#Region " Constructors "

        Protected Sub New(ByVal pblnInstantiateRequiredItems As Boolean)
            MyBase.New("IHTCTerminateDocumentUserAccessTask", pblnInstantiateRequiredItems)
        End Sub
