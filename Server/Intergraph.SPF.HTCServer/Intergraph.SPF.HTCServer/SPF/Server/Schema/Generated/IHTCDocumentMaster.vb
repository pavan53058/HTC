...
Namespace SPF.Server.Schema.Interface.Generated
    ...
    Public Interface IHTCDocumentMaster
        Inherits IObject
...
#End Region
    ...
    Public MustInherit Class IHTCDocumentMasterBase
        Inherits InterfaceBase
        Implements IHTCDocumentMaster

#Region " Constructors "

        Protected Sub New(ByVal pblnInstantiateRequiredItems As Boolean)
            MyBase.New("IHTCDocumentMaster", pblnInstantiateRequiredItems)
        End Sub
