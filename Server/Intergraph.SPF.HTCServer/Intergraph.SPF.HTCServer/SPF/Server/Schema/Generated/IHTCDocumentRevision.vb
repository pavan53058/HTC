...
Namespace SPF.Server.Schema.Interface.Generated
    ...
    Public Interface IHTCDocumentRevision
        Inherits IObject

#Region " Properties "
        Property HTCDocumentReviewStatus As String
#End Region
...
#End Region
    ...
    Public MustInherit Class IHTCDocumentRevisionBase
        Inherits InterfaceBase
        Implements IHTCDocumentRevision

#Region " Constructors "

        Protected Sub New(ByVal pblnInstantiateRequiredItems As Boolean)
            MyBase.New("IHTCDocumentRevision", pblnInstantiateRequiredItems)
        End Sub
